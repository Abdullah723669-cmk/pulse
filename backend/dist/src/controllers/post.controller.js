...
exports.deletePost = exports.addComment = exports.getPostComments = exports.likePost = exports.createPost = exports.getUserPosts = exports.getFeed = void 0;
...
const getUserPosts = async (req, res) => {
    try {
        ...
        const type = req.query.type; // 'posts', 'media', 'likes'
        const currentUserId = req.user?.id;
        ...
        let posts = [];
        if (type === 'likes') {
            const liked = await prisma_1.prisma.postLike.findMany({
...
const likePost = async (req, res) => {
    try {
        ...
        if (existingLike) {
            ...
            const likesCount = await prisma_1.prisma.postLike.count({ where: { postId } });
